...
demonstrate ctxsentry and to exercise it in CI. Every file in it contains a
...
```console
$ ctxsentry scan examples/malicious-repo --fail-on none
...
scanned 4 file(s), skipped 0 — critical=14  high=2
```

This directory is listed in `../.ctxsentryignore` so a scan of the ctxsentry
